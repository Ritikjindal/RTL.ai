...
`ifndef VERILATOR
    #1;
`endif
    // UUT.$auto$async2sync.\cc:107:execute$293  = 1'b0;
    // UUT.$auto$async2sync.\cc:116:execute$297  = 1'b1;
    UUT.gate_inst.acc = 24'b000000000000000000000000;
    UUT.gate_inst.cntx_reg = 8'b00000000;
    UUT.gate_inst.count = 8'b00000000;
    UUT.gate_inst.d4_reg = 24'b000000000000000000000000;
    UUT.gate_inst.d9_reg = 24'b000000000000000000000000;
    UUT.gate_inst.ext_reg = 16'b0000000000000000;
    UUT.gate_inst.held_reg = 16'b0000000000000000;
    UUT.gate_inst.hold = 16'b0000000000000000;
    UUT.gate_inst.in_valid_d1 = 1'b0;
    UUT.gate_inst.length = 16'b0000000000000000;
    UUT.gate_inst.lenx_reg = 16'b0000000000000000;
    UUT.gate_inst.out_data = 24'b000000000000000000000000;
    UUT.gate_inst.out_valid = 1'b0;
    UUT.gate_inst.state = 16'b0000000000000000;
    UUT.gate_inst.state5_11_reg = 6'b000000;
