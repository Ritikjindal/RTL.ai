module __eqcheck_top (
    ...
    reg [23:0] gold_out_data_d1;
    reg [3:0] gold_status_d1;

    always @(posedge clk) begin
        gold_out_valid_d1 <= gold_out_valid;
        gold_out_data_d1 <= gold_out_data;
        gold_status_d1 <= gold_status;
    end
    ...
    always @(posedge clk) begin
        if ($initstate) begin
            ...
            if (warmup >= 8'd1) assert (gold_out_valid_d1 == gate_out_valid && gold_out_data_d1 == gate_out_data && gold_status_d1 == gate_status);
        end
    end
