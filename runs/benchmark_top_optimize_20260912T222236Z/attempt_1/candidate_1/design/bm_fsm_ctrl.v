...
module bm_fsm_ctrl #(
    ...
    // Restructured to compute all results directly from d0 in parallel,
    // then select with a one-hot mux on state bits.
    ...
    // Independent computation of each result directly from d0
    ...
    // Single one-hot mux to select final value
