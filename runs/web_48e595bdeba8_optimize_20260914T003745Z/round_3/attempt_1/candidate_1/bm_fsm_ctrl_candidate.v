...
module bm_fsm_ctrl #(
    ...
    // Restructured to compute all candidates in parallel and select with one-hot mux
    ...
    // Compute all 9 candidates in parallel from d0
    ...
    // One-hot mux to select the result
    wire [ACCW-1:0] d9 = state[3]  ? cand3  :
                         state[4]  ? cand4  :
                         state[5]  ? cand5  :
                         state[6]  ? cand6  :
                         state[7]  ? cand7  :
