...
// This module owns the critical path of the full design (clock 'clk', worst slack -0.27 ns).
module mac_unit (
    input  wire        clk,
    input  wire        rst,
    input  wire        valid,
    ...
    // Everything from a_reg/b_reg through to sum is combinational - but now shorter.
