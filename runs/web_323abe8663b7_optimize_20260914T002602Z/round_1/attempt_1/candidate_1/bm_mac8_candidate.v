// This module owns the critical path of the full design (clock 'clk', worst slack -0.56 ns).
module bm_mac8 #(
    ...
    // Balanced binary adder tree (3 levels deep).
    // Level 1: 4 parallel adds
    wire [ACCW-1:0] t0 = m0 + m1;
    wire [ACCW-1:0] t1 = m2 + m3;
    wire [ACCW-1:0] t2 = m4 + m5;
    wire [ACCW-1:0] t3 = m6 + m7;

    // Level 2: 2 parallel adds
    wire [ACCW-1:0] u0 = t0 + t1;
    wire [ACCW-1:0] u1 = t2 + t3;

    // Level 3: 1 add
    wire [ACCW-1:0] sum = u0 + u1;
