...
module bm_fir6 #(
    ...
    reg                 vld;
    reg signed [ACCW-1:0] p0_r, p1_r, p2_r, p3_r, p4_r, p5_r;
    reg                 vld2;
    ...
    wire signed [ACCW-1:0] s1 = p0_r + p1_r;
    wire signed [ACCW-1:0] s2 = s1 + p2_r;
    wire signed [ACCW-1:0] s3 = s2 + p3_r;
    wire signed [ACCW-1:0] s4 = s3 + p4_r;
    wire signed [ACCW-1:0] s5 = s4 + p5_r;
