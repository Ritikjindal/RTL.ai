...
module mac_unit (
    ...
    // Everything from a_reg/b_reg through to sum is combinational - now a shorter path.
    ...
    // Pipeline register stage between multiply/adder-tree and final accumulator
    always @(posedge clk) begin
        if (rst) begin
            sum_reg   <= 18'd0;
            valid_reg2 <= 1'b0;
