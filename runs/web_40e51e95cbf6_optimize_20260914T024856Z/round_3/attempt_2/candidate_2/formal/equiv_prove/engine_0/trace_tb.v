...
`ifndef VERILATOR
    #1;
`endif
    // UUT.$auto$async2sync.\cc:107:execute$308  = 1'b0;
    // UUT.$auto$async2sync.\cc:116:execute$312  = 1'b1;
    ...
    UUT.gate_inst.out_data_r = 24'b000000000000000000000000;
    UUT.gate_inst.out_valid = 1'b0;
    UUT.gate_inst.out_valid_r = 1'b0;
